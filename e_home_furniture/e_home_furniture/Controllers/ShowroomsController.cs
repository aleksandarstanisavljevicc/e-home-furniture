...
namespace e_home_furniture.Controllers
{
    public class ShowroomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "showRoomId,showRoomName,Owner,address,phone,e_mail,web_Site,taxId,bankAccountNumber")] Showroom showroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "showRoomId,showRoomName,Owner,address,phone,e_mail,web_Site,taxId,bankAccountNumber")] Showroom showroom)
        {
            if (ModelState.IsValid)
            {
